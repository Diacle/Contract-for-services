THIS IS A JURISDICTION-NEUTRAL TEMPLATE. PLEASE SEEK LEGAL ADVICE IN YOUR JURISDICTION TO ENSURE VALIDITY AND ENFORCEABILITY OF THIS DOCUMENT. THE TEMPLATE IS PREPARED TO PROTECT THE INTERESTS OF BOTH SIDES OF A TRANSACTION. IT IS NOT ONE-SIDED. THE TEMPLATE CAN THEN BE COPIED AND THE COPY CAN BE CHANGED TO ADD CHANGES IN THE FORM IN PARTICULAR THAT ARE BIAS TOWARDS ONE PARTICULAR SIDE. THOSE ADDITIONAL CHANGES ARE THE ONES THAT WILL BE NEGOTIATED BETWEEN THE PARTIES. 

THE SERVICES OFFERED UNDER THIS TEMPLATE IS MAINLY A CONSULTANCY SERVICE. THIS MEANS THAT THE WORKS PRODUCED BY THE SUPPLIER ARE MAINLY IN THE FORMS OF DOCUMENTS AND REPORTS OR SIMILAR MATERIALS. THE SUPPLIER KEEPS THE OWNERSHIP OF ITS INTELLECTUAL PROPERTY BUT THEN GIVES PERMISSION FOR THE CLIENT TO KEEP AND REPRODUCE BUT ONLY FOR THE PURPOSE OF THIS AGREEMENT. 

IF THE SUPPLIER IS DEVELOPING SOFTWARE FOR A CLIENT THEN ANOTHER TEMPLATE SHOULD BE CONSIDERED OR YOU SHOULD LOOK AT THE IP CLAUSE MORE CAREFULLY. IF THE SUPPLIER IS PROVIDING SOFTWARE AS A SERVICE OR SOME KIND OF OUTSOURCING FUNCTION THEN THIS TEMPLATE MAY NOT WORK OR WOULD NEED TO BE ADAPTED. 
...
4. Point of contact:
Representative of Party 2 for contact
Email address for notices:
Commencement Date:
On the date of signature unless agreed otherwise.

5. Term:
Rolling contract terminated with notice 
...
12.1 The procedure for requesting Inventory shall be as follows:
...
This will determine which courts are able to be used to resolve the dispute between the parties. Indicating a jurisdiction does not mean necessarily that a court will be able to hear your case. That will depend on the interpretation of jurisdiction at the time you make an application. England and Wales
...
The Supplier undertakes to supply the services from the commencement date and in accordance with this Agreement. The Supplier shall:
